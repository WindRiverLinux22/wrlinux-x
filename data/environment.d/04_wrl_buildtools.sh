...
BUILDTOOLS_VERSION=${BUILDTOOLS_VERSION:-10.22.33.6b}
BUILDTOOLS_EXT_VERSION=${BUILDTOOLS_EXT_VERSION:-10.22.33.6b}

# Special windshare folders to search
BUILDTOOLS_FOLDERS="WRLinux-lts-22-Core WRLinux-lts-22-Base"
